    ...
    for images,labels in test_loader:
        ...
        for image in images:
            ...
            image_list = [
                          ...
                          T.ColorJitter(hue=.05, saturation=.05)(image),
                          T.RandomPerspective(p=1)(image),
                          T.RandomAffine(degrees=20)(image),
                          T.RandomRotation(90, resample=PIL.Image.BILINEAR)(image),
                          T.RandomHorizontalFlip(p=1)(image),
            ]
            # turn all replications into tensors
            replications = [T.ToTensor()(image) for image in image_list
